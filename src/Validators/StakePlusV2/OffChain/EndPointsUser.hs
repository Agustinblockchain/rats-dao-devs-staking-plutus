...
import qualified Validators.StakePlusV2.Types.Constants                     as T -- (tokenNameLenght, maxDiffTokensForUserDatum, poolID_TN, fundID_TN, userID_TN, txID_Master_AddScripts_TN, txID_User_Deposit_For_User_TN, validTimeRange, txID_User_Harvest_TN, txID_User_Withdraw_TN, scriptID_Master_Fund_TN, scriptID_Master_FundAndMerge_TN, scriptID_Master_SplitFund_TN , scriptID_Master_ClosePool_TN, scriptID_Master_TerminatePool_TN, scriptID_Master_DeleteFund_TN, scriptID_Master_SendBackFund_TN, scriptID_Master_SendBackDeposit_TN, scriptID_Master_AddScripts_TN, scriptID_Master_DeleteScripts_TN, scriptID_User_Deposit_TN, scriptID_User_Harvest_TN, scriptID_User_Withdraw_TN, scriptID_Validator_TN)
import qualified Validators.StakePlusV2.Types.DatumsValidator               as T -- (DatumValidator (PoolDatum, FundDatum), mkUserDatum, TxOut_Value_And_FundDatum, PoolDatumTypo (..), UserDatumTypo (..))
import qualified Validators.StakePlusV2.Types.RedeemersMint                 as T -- (mkRedeemerMint_TxID, mkRedeemerBurn_TxID)
import qualified Validators.StakePlusV2.Types.RedeemersValidator            as T -- (mkRedeemerUserDeposit, mkRedeemerUserHarvest, redeemerValidatorToBuiltinData, mkRedeemerUserWithdraw)
import qualified Validators.StakePlusV2.Types.PABParams                     as T -- (PABUserDepositParams (..), PABPoolParams (..), PABUserHarvestParams (..), PABUserWithdrawParams (..))
...
userDeposit T.PABUserDepositParams{..} = do
    ...
    ---------------------
        !txID_User_Deposit_For_User_CS =  userID_CS
        !txID_User_Deposit_For_User_AC = LedgerValue.AssetClass (txID_User_Deposit_For_User_CS, T.txID_User_Deposit_For_User_TN)
    ---------------------
    ...
    ---------------------
    !uTxO_With_Script_User_Deposit' <- OffChainHelpers.getUTxO_With_ScriptDatum txID_Master_AddScripts_AC scriptID_User_Deposit_AC uTxOsAtValidator
    ---------------------
    ...
    ---------------------
        !value_For_Mint_TxID_User_Deposit_For_User = LedgerValue.assetClassValue txID_User_Deposit_For_User_AC investAmount
    ---------------------
    ...
    ---------------------
        ...
        !redeemer_For_Mint_TxID_User_Deposit_For_User = T.mkRedeemerMint_TxID redeemer_For_Consuming_Validator_Datum
    ---------------------
    ...
    ---------------------
    let
        (lookupsTx_MintUserID, txMintUserID) = OffChainHelpers.mintToken_With_RefPolicy uTxOsAtUser uTxO_With_Script_User_Deposit (Just redeemer_For_Mint_TxID_User_Deposit_For_User) value_For_Mint_UserID validityRange userPPKH
        (lookupsTx_Mint_TxID_User_Deposit, tx_Mint_TxID_User_Deposit) = OffChainHelpers.mintToken_With_RefPolicy uTxOsAtUser uTxO_With_Script_User_Deposit (Just redeemer_For_Mint_TxID_User_Deposit_For_User) value_For_Mint_TxID_User_Deposit_For_User validityRange userPPKH
        lookupsTx =
...
userHarvest T.PABUserHarvestParams{..} = do
    ...
    !uTxO_With_ScriptDatum <- 
        case uTxO_With_ScriptDatum' of
            ...
            Just uTxO_With_ScriptDatum -> do
                ...
                return uTxO_With_ScriptDatum
    ---------------------
    !uTxO_With_Script_User_Harvest' <- OffChainHelpers.getUTxO_With_ScriptDatum txID_Master_AddScripts_AC scriptID_User_Harvest_AC uTxOsAtValidator
    ---------------------
    ...
    let
        ...
        formatFundDatumOutputsList list = concat [  ["----", "FundDatum': " ++ P.show  fundDatum, "FundDatum Value: " ++ P.show value_For_FundDatum] | (fundDatum, value_For_FundDatum) <- list]
...
userWithdraw T.PABUserWithdrawParams{..} = do
    ...
    !uTxO_With_Script_User_Deposit <- 
        case uTxO_With_Script_User_Deposit' of
            ...
            Just uTxO_With_Script_User_Deposit -> do
                ...
                return uTxO_With_Script_User_Deposit   
    ---------------------
    !uTxO_With_Script_User_Withdraw' <- OffChainHelpers.getUTxO_With_ScriptDatum txID_Master_AddScripts_AC scriptID_User_Withdraw_AC uTxOsAtValidator
    ---------------------
    ...
    ---------------------
        !value_For_Burn_TxID_User_Deposit = LedgerValue.assetClassValue txID_User_Deposit_For_User_AC (-investAmount)
    ...
    if isFundCountZero then do
        ...
        ---------------------
            ...
            !value_For_FundDatum = value_In_FundDatum <> value_For_Mint_TxID_User_Withdraw <> value_In_UserDatum <> value_For_Burn_UserID <> negate value_For_User
        ---------------------
        PlutusContract.logInfo @P.String $ TextPrintf.printf "--------------------------------------------------------------------------------------------"
        PlutusContract.logInfo @P.String $ TextPrintf.printf "--------------------------- User Withdraw : Ending ---------------------------------------"
